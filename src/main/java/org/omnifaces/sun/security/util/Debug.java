...
import static org.omnifaces.sun.security.action.GetPropertyAction.privilegedGetProperty;
...
public class Debug {
    ...
    static {
        args = privilegedGetProperty("java.security.debug");

        String args2 = privilegedGetProperty("java.security.auth.debug");
    ...
    /**
     * Get a Debug object corresponding to whether or not the given option is set. Set the prefix to be
     * the same as option.
     */
    ...
    public void println(Object obj, String message) {
        System.err.println(prefix + " [" + obj.getClass().getSimpleName() + "@" + System.identityHashCode(obj) + "]: " + message);
    }
    ...
    /**
     * return a hexadecimal printed representation of the specified BigInteger object. the value is
     * formatted to fit on lines of at least 75 characters, with embedded newlines. Words are separated
     * for readability, with eight words (32 bytes) per line.
     */
