...
/**
 * A utility class to expand properties embedded in a string. Strings of the form
 * ${some.property.name} are expanded to be the value of the property. Also, the special ${/}
 * property is expanded to be the same as file.separator. If a property is not set, a
