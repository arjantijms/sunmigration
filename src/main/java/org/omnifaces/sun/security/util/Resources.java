...
/**
 * This class represents the <code>ResourceBundle</code> for javax.security.auth and sun.security.
 *
 */
public class Resources extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
            ...
            { "invalid.null.input.s.", "invalid null input(s)" }, { "actions.can.only.be.read.", "actions can only be 'read'" },
            ...
            { "java.security.policy.error.adding.Permission.perm.message", "java.security.policy: error adding Permission, {0}:\n\t{1}" },
            ...
            { "substitution.value.prefix.unsupported", "substitution value, {0}, unsupported" }, { "SPACE", " " }, { "LPARAM", "(" },
            { "RPARAM", ")" }, { "type.can.t.be.null", "type can't be null" },

            // sun.security.provider.PolicyParser
            { "keystorePasswordURL.can.not.be.specified.without.also.specifying.keystore",
                    "keystorePasswordURL can not be specified without also specifying keystore" },
            { "expected.keystore.type", "expected keystore type" }, { "expected.keystore.provider", "expected keystore provider" },
            ...
            { "duplicate.keystore.name", "duplicate keystore name: {0}" }, { "SignedBy.has.empty.alias", "SignedBy has empty alias" },
