...
package org.omnifaces.sun.security.util;
...
/**
 * A utility class for getting a KeyStore instance from policy information. In addition, a
 * supporting getInputStream method.
 *
 */
public class PolicyUtil {
    ...
    /*
     * Fast path reading from file urls in order to avoid calling FileURLConnection.connect() which can
     * be quite slow the first time it is called. We really should clean up FileURLConnection so that
     * this is not a problem but in the meantime this fix helps reduce start up time noticeably for the
     * new launcher. -- DAC
     */
    ...
    /**
     * this is intended for use by the policy parser to instantiate a KeyStore from the information in
     * the GUI/policy file
     */
    public static KeyStore getKeyStore(URL policyUrl, // URL of policy file
        ...
        try {
            ...
            if (NONE.equals(keyStoreName)) {
                ...
                /*
                 * location of keystore is specified as absolute URL in policy file, or is relative to URL of policy
                 * file
                 */
